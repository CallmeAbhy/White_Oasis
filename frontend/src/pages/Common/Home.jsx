  ...
  useEffect(() => {
    const fetchHomeSection = async () => {
      try {
        ...
        console.log(jsondata.currentDayImage.url);
        SetHomeSection({
        ...
        <div className="relative container mx-auto px-4 h-full flex items-center">
          <div className="max-w-2xl text-white">
            <h1 className="text-5xl font-bold mb-6">
              {homeSection.title || "Compassionate Elderly Care for Elders"}
            </h1>
            ...
            {[
              {
                ...
                description: "Round-the-clock medical supervision and support",
              },
              {
                icon: faUserFriends,
                title: "Social Activities",
                description: "Engaging social programs and community events",
              },
              {
                icon: faCalendarAlt,
                title: "Scheduled Care",
                description: "Personalized care plans and daily assistance",
              },
              {
                icon: faClock,
